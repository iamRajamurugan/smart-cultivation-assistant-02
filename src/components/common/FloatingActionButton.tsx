...
const FloatingActionButton = () => {
  return (
    <Link
      to="/scanner"
      className="fixed bottom-20 z-20 left-1/2 transform -translate-x-1/2 h-16 w-16 rounded-full bg-farming-green text-white shadow-lg flex items-center justify-center glow-effect"
